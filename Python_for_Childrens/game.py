try:
    ...
    def run_game(libe):
        ...
        score = 0
        do_liberint(libe,pygame,ship,Block,aliens,blocks,Alien_what_go_left_and_right,ai_settings,screen,0,Alien_what_go_up_and_down,poweraps,die_blocks,alien,0,0,0,0)
