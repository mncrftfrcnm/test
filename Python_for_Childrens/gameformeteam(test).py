                ...
                #for event in pygame.event.get():
                    ...
                    if event.type == pygame.KEYDOWN:
                        ...
                        if event.key == pygame.K_e:
                            if ship.rect.y <= alien.rect.y+222 and ship.rect.x <= alien.rect.x+222 and ship.rect.y >= alien.rect.y-222 and ship.rect.x >= alien.rect.x-222:
                        ...
                        if event.key == pygame.K_RALT:
                            if ship2.rect.y <= alien.rect.y+222 and ship2.rect.x <= alien.rect.x+222 and ship2.rect.y >= alien.rect.y-222 and ship2.rect.x >= alien.rect.x-222:
