...
class Ship(Sprite):
    def __init__(self,ai_settings,screen,mouse_x,mouse_y):
        ...
        self.rect = pygame.Rect(mouse_x,mouse_y,ai_settings.bullet_width,ai_settings.bullet_height)
        self.mouse_x,self.mouse_y = self.rect.x,self.rect.y
...
class Alien(Sprite):
    def __init__(self,ai_settings,screen,ship):
        ...
        self.ai_settings = ai_settings
        self.screen = screen
        self.xp = randint(0,100)
        self.yp = randint(0,100)
    ...
    def update(self):
        ...
        self.rect.x = self.ship.rect.x + self.xp
        self.rect.y = self.ship.rect.y + self.yp
...
def run_game():
    ...
    aliens = Group()
    ships = Group()
    ship = Ship(ai_settings,screen,0,0)
    #ships.add(ship)
    ...
    while True:
        ...
        #        if turtle== 1:
                    #shi[]
                ship.mouse_x = mouse_x
                ship.mouse_y = mouse_y
        ships.update()
