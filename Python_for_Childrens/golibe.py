try:
    ...
    def run_game():
        ...
        ships2.add(ship2)
        ships.add(ship)
        bul = Bullet(ai_settings,screen,ship,aliens,bullets,t)
        while True:
            # if cr == 0:
            ...
            if bul.t == 1:
                ...
                bul.x += fuster
                bul.rect.x = bul.x
                if pygame.sprite.spritecollideany(bul,blocks):
                    bul.x -= fuster
                    bul.rect.x = bul.x
                    tre = randint(0,1)
                    if tre == 0:
                ...
                if pygame.sprite.spritecollideany(bul,die_blocks):
                    bul.x += fuster
                    bul.rect.x = bul.x
