try:
    ...
    bulets = 1
    import pygame.font
    tre = input('(mangal,fire,supercat):')
    ert = input('(mangal,fire,supercat):')
    if tre == 'fire' and ert == 'fire':
        im = pygame.image.load('fire.gif')
        num = 0
    if tre == 'fire' and ert == 'supercat':
        im = pygame.image.load('robot.gif')
        num = 1
    if ert == 'fire' and tre == 'supercat':
        im = pygame.image.load('robot.gif')
        num = 1
    if ert == 'supercat' and tre == 'supercat':
        im = pygame.image.load('supercat.gif')
        num = 3
    class Scoreboard():
    ...
    def run_game():
        global ch,dobollet,t,bulets,score,im,num
        forrand = 1000
        pygame.init()
