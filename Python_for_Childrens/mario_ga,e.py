...
#    def run_game():
    def run_game():
        ...
        sty = Group()
        uii = 0
        do_liberint(pygame,Block,blocks,ai_settings,screen,'liberint.txt',Alien,aliens,poweraps)
        upup = 0
...
#                 if status == 1:
#                     if event_type == 'a' or event_type == 'x':
#                         j = True
#                     if event_type == 'b' or event_type == 'y':
#                         bullet = Bullet(ai_settings,screen,ship,0,0,0,t)        
#                         bullets.add(bullet)               
#             rand = randint(-1000,1000)
#             if upup == 1:
#                 for alien in blocks.sprites():
