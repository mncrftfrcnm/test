try:
    ...
    def run_game():
        ...
        ship2.rect.y = ai_settings.screen_height-150
        ship2.rect.x = ai_settings.screen_width-150
                
        ship2.y = ai_settings.screen_height-150
        ship2.x = ai_settings.screen_width-150
        ...
        score = 0
        do_liberint(pygame,ship,Block,aliens,blocks,Alien_what_go_left_and_right,ai_settings,screen,0,Alien_what_go_up_and_down,poweraps,die_blocks,alien)
            ...
            if trere == 0:
                if cr2 == 0:
                    ...
                    if pygame.sprite.spritecollideany(ship2,blocks):
                        ship2.x += fuster
                        ship2.rect.x = ship2.x
                    if pygame.sprite.spritecollideany(ship2,die_blocks):
                        ship2.x += fuster
                        ship2.rect.x = ship2.x
            ...
            #        for i in range(button):
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_v:
                        new_bullet = Bullet(ai_settings,screen,ship2,aliens,bullets,t2)
                        bullets.add(new_bullet)
                        bullets.add(new_bullet)
...
#276
 ...
 #           pygame.display.flip()
            ...
            collisions = pygame.sprite.groupcollide(ships,bullets,True,True)
            collisions = pygame.sprite.groupcollide(ships,bullets2,True,True)
            
            collisions = pygame.sprite.groupcollide(bullets,ships,True,True)
            ...
            for bullet in bullets.sprites():
                ...
                if pygame.sprite.spritecollideany(ship,bullets):
                    print('2p')
                    sys.exit()
                collisions = pygame.sprite.groupcollide(bullets,die_blocks,True,True)
                collisions = pygame.sprite.groupcollide(bullets,aliens,True,True)
            ...
            for bullet in bullets2.sprites():
                collisions = pygame.sprite.groupcollide(ships2,bullets2,True,True)
                if collisions:
                    print('1p')
                    sys.exit()
                bullet.draw_bullet()
            ...
            bullets2.update(bullets,aliens)
