try:
    ...
    def run_game2():
        ...
        alien.rect.x = alien.x
        aen.rect.y = alien.y
        do_liberint(ship,Alien,ai_settings,screen,aliens,blocks,aiens)
        ships.add(ship)
        print(len(ships))
        libes = 0
        bg_color = (20,250,200)
...
#276
 ...
 #           print(len(alienbullets))
    ...
    def run_game():
        ...
        do_liberint(ship,Alien,Alen2,ai_settings,screen,aliens,aiens,Button,buttons,ty)
